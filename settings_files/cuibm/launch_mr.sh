...
cp /g/g17/welton2/repo/cuda_deduplicator/settings_files/cuibm/MR_settings.ini /g/g17/welton2/scratch/nfs/apps/cuIBM/examples/lidDrivenCavity/Re5000/settings.ini
