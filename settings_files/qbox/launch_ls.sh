# bsub -nnodes 1 -G guests -W 100 /g/g17/welton2/repo/cuda_deduplicator/settings_files/cumf_als/launch_ls.sh
...
cp /g/g17/welton2/repo/cuda_deduplicator/settings_files/qbox/LS_settings.ini /g/g17/welton2/scratch/nfs/apps/qbox_dir/qbox-public/src/gold-bench/settings.ini
