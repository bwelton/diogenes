...
cp /g/g17/welton2/repo/cuda_deduplicator/settings_files/qbox/ST_settings.ini /g/g17/welton2/scratch/nfs/apps/qbox_dir/qbox-public/src/gold-bench/settings.ini
