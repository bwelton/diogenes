...
gotcha_wrappee_handle_t autocorr_cuMemcpyDtoH_v2_handle;
...
typeof(&autocorr_cuMemcpyDtoH_v2) autocorr_cuMemcpyDtoH_v2_wrapper;
...
struct gotcha_binding_t gotcha_Binder_Funcs22[] = {{"cuMemHostAlloc",(void*)autocorr_cuMemAllocHost_v2,&autocorr_cuMemAllocHost_v2_handle},
												 ...
												 {"cuMemcpyDtoH_v2",(void*)autocorr_cuMemcpyDtoH_v2,&autocorr_cuMemcpyDtoH_v2_handle},
...
void ac_mutatee_init() {
    ...
    autocorr_cuMemcpyDtoH_v2_wrapper = (typeof(&autocorr_cuMemcpyDtoH_v2))dlsym(lib_libcuda,"cuMemcpyDtoH_v2");
	...
	gotcha_wrap(gotcha_Binder_Funcs22, sizeof(gotcha_Binder_Funcs22)/sizeof(struct gotcha_binding_t), "binderWrappers");
}
}
